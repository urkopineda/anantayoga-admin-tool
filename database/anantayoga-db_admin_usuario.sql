...
CREATE TABLE `admin_usuario` (
  `ID_ADMIN_USUARIO` int(11) NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COMMENT='Aquí guardaremos todos los datos de los usuarios';
